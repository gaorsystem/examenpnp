...
const correctMatches = {
  ...
  1263: "CÓNYUGES",
  1264: "MADRASTRAS",
  1265: "LOS PARIENTES DE LOS EXCÓNYUGES Y CONVIVIENTES HASTA EL CUARTO GRADO DE CONSANGUINIDAD Y SEGUNDO DE AFINIDAD",
  ...
  if (optIdx === -1) {
    ...
    if(q.numero === 1265) {
      return {
        ...
        respuesta: q.opciones[4].trim(), // "LOS PARIENTES COLATERALES HASTA EL CUARTO GRADO DE CONSANGUINIDAD Y SEGUNDO DE AFINIDAD."
        ubicacion: "Ley 30364"
      }
    }
