...
const TEMA_METADATA: Record<string, { imagen: string, color: string }> = {
  'CONSTITUCIÓN POLÍTICA DEL PERÚ': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-red-900' },
  'D.L. 1267 - LEY DE LA POLICÍA NACIONAL DEL PERÚ': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-emerald-900' },
  'DECRETO LEGISLATIVO N° 1291 - LUCHA CONTRA LA CORRUPCIÓN': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-blue-900' },
  'LEY N° 27806 - LEY DE TRANSPARENCIA Y DE ACCESO A LA INFORMACIÓN': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-sky-800' },
  'LEY DE PROCESOS DE ASCENSO DE LA POLICÍA NACIONAL DEL PERÚ': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-indigo-900' },
  'LEY N° 27444 - LEY DEL PROCEDIMIENTO ADMINISTRATIVO GENERAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-slate-800' },
  'D.L. 957 - CÓDIGO PROCESAL PENAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-violet-900' },
  'DECRETO LEGISLATIVO Nº 635 - CÓDIGO PENAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-zinc-900' },
  'D.L. 1186 - USO DE LA FUERZA PNP': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-orange-800' },
  'D.L. 1241 - LUCHA CONTRA EL TRÁFICO ILÍCITO DE DROGAS': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-teal-900' },
  'D.L. 1106 - LUCHA EFICAZ CONTRA EL LAVADO DE ACTIVOS Y LA MINERÍA ILEGAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-amber-800' },
  'LEY 30364 - PREVENIR, SANCIONAR Y ERRADICAR LA VIOLENCIA CONTRA LAS MUJERES Y LOS INTEGRANTES DEL GRUPO FAMILIAR': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-rose-900' },
  'LEY 30077 - LEY CONTRA EL CRIMEN ORGANIZADO': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-gray-900' },
  'PROTOCOLOS DE ACTUACIÓN INTERINSTITUCIONAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-cyan-900' },
  'LEY 32130 - LEY PARA FORTALECER LA INVESTIGACIÓN DEL DELITO': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-fuchsia-900' },
  'D. LEG. 1611 - PREVENCIÓN E INVESTIGACIÓN DEL DELITO DE EXTORSIÓN': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-stone-800' },
  'DERECHOS HUMANOS APLICADOS A LA FUNCIÓN POLICIAL': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-red-800' },
  'DL N° 1428 - ATENCIÓN DE CASOS DE DESAPARICIÓN DE PERSONAS': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-blue-800' },
  'LEY 30714 - RÉGIMEN DISCIPLINARIO DE LA PNP': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-slate-900' },
  'D.L. 1149 - LEY DE LA CARRERA Y SITUACIÓN DEL PERSONAL PNP': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-emerald-800' },
  'D.L. 1318 - RÉGIMEN DE FORMACIÓN DE LA PNP': { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-indigo-800' }
};
...
export function getNormasInfo(): NormaInfo[] {
  ...
  map.forEach((value, key) => {
    const slug = key
      ...
      .replace(/[^a-z0-9]+/g, '-')
      .replace(/(^-|-$)/g, '');
    const meta = TEMA_METADATA[key] || { imagen: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80', color: 'bg-slate-800' };
    list.push({
      id: idCounter++,
      nombre: key,
      grupo: value.grupo,
